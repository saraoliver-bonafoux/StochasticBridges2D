...
!
! In this example, we use the file "PQS_geneticswitch_Continuous.txt". 
...
program Bridges2D_Continuous
	...
	character(len=40) :: filename_PQS = "PQS_geneticswitch_Continuous.txt" 
	!!! General definitions
...
contains
	...
	double precision function sample_gaussian(mu, sigma) 
		...
		sample_gaussian = sigma * dran_g() + mu ! dran_g(): generates a Gaussian random variable of mean 0 and variance 1
